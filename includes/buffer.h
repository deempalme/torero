...
namespace Toreo {
  ...
  public:
    ...
    void allocate_array(const GLvoid *data, GLsizei size_in_bytes, GLenum ussage = GL_STATIC_DRAW){
      if(!has_array_buffer_){
    ...
    void allocate_element(const GLvoid *data, GLsizei size_in_bytes, GLenum ussage = GL_STATIC_DRAW){
      if(!has_element_buffer_){
    ...
    void attributte_buffer(GLuint index, GLint size, GLint offset, GLsizei stride,
