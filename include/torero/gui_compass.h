...
namespace Toreo {
  ...
  private:
    ...
    std::vector<Visualizer::PBR_GUIShader> compass_objects_;

    Buffer buffer_steering_, buffer_steering_objects_;
    GLsizei steering_data_size_;
    float previous_steering_angle_;
    std::vector<Visualizer::PBR_GUIShader> steering_objects_;
    ...
    std::vector<Visualizer::PBR_GUIShader> clutch_objects_;
    ...
    std::vector<Visualizer::ComplexShaderData> data_background_, data_compass_, data_steering_;
    std::vector<Visualizer::ComplexShaderData> data_clutch_, data_marker_, data_needle_;
