...
namespace Toreo {
  ...
  public:
    ...
    void set_vertical_alignment(const Visualizer::Alignment
                                alignment = Visualizer::Alignment::TOP);
    void set_horizontal_alignment(const Visualizer::Alignment
                                  alignment = Visualizer::Alignment::LEFT);

    void set_weight(const Visualizer::TextWeight weight = Visualizer::TextWeight::NORMAL);
  ...
  private:
    ...
    void text_metrics(const std::string &text, Algebraica::vec2f *offset,
                      ...
                      std::vector<Visualizer::TextSimpleShader> *simple = nullptr,
                      std::vector<Visualizer::TextColoredShader> *colored = nullptr);
    ...
    Visualizer::Alignment vertical_alignment_;
    Visualizer::Alignment horizontal_alignment_;
