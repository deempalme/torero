#ifndef TORERO_GROUND_GROUND_H
#define TORERO_GROUND_GROUND_H
...
namespace torero {
  namespace ground {
    ...
    {
    public:
      Ground(torero::gl::Shader *ground_shader);

      void change_input(const std::vector<torero::ground::Ground2D> *ground);
      void change_input(const std::vector<torero::ground::Ground3D> *ground);
      void change_input(const std::vector<torero::ground::Grid> *ground);
      void change_input(const std::vector<torero::ground::Free2D> *ground);
      void change_input(const std::vector<torero::ground::Free3D> *ground);
      void change_input(const std::vector<torero::ground::FreePolar2D> *ground);
      void change_input(const std::vector<torero::ground::FreePolar3D> *ground);
    ...
    private:
      ...
      const std::vector<torero::ground::Ground2D> *ground_2D_;
      const std::vector<torero::ground::Ground3D> *ground_3D_;
      const std::vector<torero::ground::Grid> *ground_grid_;
      const std::vector<torero::ground::Free2D> *free_ground_2D_;
      const std::vector<torero::ground::Free3D> *free_ground_3D_;
      const std::vector<torero::ground::FreePolar2D> *polar_ground_2D_;
      const std::vector<torero::ground::FreePolar3D> *polar_ground_3D_;
