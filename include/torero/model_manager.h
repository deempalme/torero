...
namespace Toreo {
  ...
  public:
    ...
    bool skybox(const std::string up    = "resources/skybox/up.png",
                const std::string down  = "resources/skybox/down.png",
                const std::string left  = "resources/skybox/left.png",
                const std::string right = "resources/skybox/right.png",
                const std::string front = "resources/skybox/front.png",
                const std::string back  = "resources/skybox/back.png");
    // Draws skybox
    bool skybox_draw();
