...
namespace torero {
  ...
  namespace text {
     ...
     */
      ...
      const std::vector<torero::text::FontCharacter> *font_characters(const FTid font) const;
      void purge_fonts();
      ...
      TXMid add_3D(FTid font,
                   const std::vector<torero::text::Simple> *data,
                   const std::string name,
                   const algebraica::mat4f *transformation_matrix = nullptr,
                   const bool visible = true);
      TXMid add_3D(FTid font,
                   const std::vector<torero::text::Colored> *data,
                   const std::string name,
                   const algebraica::mat4f *transformation_matrix = nullptr,
                   const bool visible = true);
     ...
     *
     */
      bool change_input(TXMid id, const std::vector<torero::text::Simple> *data);
      bool change_input(TXMid id, const std::vector<torero::text::Colored> *data);
      /*
     ...
     */
      ...
      bool set_font_weight(TXMid id, const torero::text::Weight
                           width = torero::text::Weight::Normal);
     ...
     */
      ...
      bool set_horizontal_alignment(TXMid id, const torero::text::Alignment
                                    alignment = torero::text::Alignment::Left);
      bool set_vertical_alignment(TXMid id, const torero::text::Alignment
    ...
    private:
      ...
      std::vector<text::FontLoader*> fonts_;
      std::map<FTid, std::vector<torero::text::Index>> text_indices_;
      std::vector<torero::text::Text> texts_;
